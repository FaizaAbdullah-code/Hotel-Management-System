...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="bisque3")
        ...
        self.Label1.configure(background="cornsilk")
        ...
        self.Text1.configure(background="cornsilk")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="bisque3")
        ...
        self.Label2.configure(background="cornsilk")
        ...
        self.Text2.configure(background="cornsilk")
